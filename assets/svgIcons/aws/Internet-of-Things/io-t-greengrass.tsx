...
const SvgIoTGreengrass = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      <path fill="url(#IoT-Greengrass_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
const Memo = memo(SvgIoTGreengrass);
export default Memo;
