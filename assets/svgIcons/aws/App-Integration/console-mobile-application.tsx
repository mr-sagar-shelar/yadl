...
const SvgConsoleMobileApplication = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        id="Console-Mobile-Application_svg__a"
        x1="0%"
        x2="100%"
        y1="100%"
        y2="0%"
    ...
    <g fill="none" fillRule="evenodd">
      <path fill="url(#Console-Mobile-Application_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
const Memo = memo(SvgConsoleMobileApplication);
export default Memo;
