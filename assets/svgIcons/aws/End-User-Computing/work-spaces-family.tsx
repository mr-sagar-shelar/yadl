...
const SvgWorkSpacesFamily = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      <path fill="url(#WorkSpaces-Family_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
const Memo = memo(SvgWorkSpacesFamily);
export default Memo;
