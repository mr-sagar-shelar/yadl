...
const SvgTransferFamily = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      <path fill="url(#Transfer-Family_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
const Memo = memo(SvgTransferFamily);
export default Memo;
