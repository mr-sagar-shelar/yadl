...
const SvgServiceManagementConnector = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <clipPath id="Service-Management-Connector_svg__a">
        <path d="M80 0v80H0V0z" />
      </clipPath>
      <clipPath id="Service-Management-Connector_svg__c">
      ...
      <linearGradient
        id="Service-Management-Connector_svg__b"
        x1={0}
        x2={80}
        y1={80}
        y2={0}
    ...
    <g clipPath="url(#Service-Management-Connector_svg__a)">
      <path
        fill="url(#Service-Management-Connector_svg__b)"
        d="M0 0h80v80H0z"
      />
    </g>
    <g
      clipPath="url(#Service-Management-Connector_svg__c)"
...
const Memo = memo(SvgServiceManagementConnector);
export default Memo;
