...
const SvgWorkDocsSdk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      <path fill="url(#WorkDocs-SDK_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
const Memo = memo(SvgWorkDocsSdk);
export default Memo;
