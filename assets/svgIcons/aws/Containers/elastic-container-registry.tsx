...
const SvgElasticContainerRegistry = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        id="Elastic-Container-Registry_svg__a"
        x1="0%"
        x2="100%"
        y1="100%"
        y2="0%"
    ...
    <g fill="none" fillRule="evenodd">
      <path fill="url(#Elastic-Container-Registry_svg__a)" d="M0 0h80v80H0z" />
      <path
        fill="#FFF"
...
const Memo = memo(SvgElasticContainerRegistry);
export default Memo;
