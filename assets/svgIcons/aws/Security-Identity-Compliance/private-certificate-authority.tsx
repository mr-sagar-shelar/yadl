...
const SvgPrivateCertificateAuthority = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <clipPath id="Private-Certificate-Authority_svg__a">
        <path d="M80 0v80H0V0z" />
      </clipPath>
      <clipPath id="Private-Certificate-Authority_svg__c">
      ...
      <linearGradient
        id="Private-Certificate-Authority_svg__b"
        x1={0}
        x2={80}
        y1={80}
        y2={0}
    ...
    <g clipPath="url(#Private-Certificate-Authority_svg__a)">
      <path
        fill="url(#Private-Certificate-Authority_svg__b)"
        d="M0 0h80v80H0z"
      />
    </g>
    <g
      clipPath="url(#Private-Certificate-Authority_svg__c)"
...
const Memo = memo(SvgPrivateCertificateAuthority);
export default Memo;
