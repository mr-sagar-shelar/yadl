...
const SvgRedHatDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="RedHat-Dark_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="RedHat-Dark_svg__b">
        <path fill="#fff" d="M40 61h175v133H40z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgRedHatDark);
export default Memo;
