...
const SvgSublimeLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="Sublime-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="Sublime-Light_svg__b">
        <path fill="#fff" d="M40 40h175v175H40z" />
      </clipPath>
      <linearGradient
        id="Sublime-Light_svg__c"
        x1={7476.84}
        x2={8041.22}
        y1={5387.54}
        y2={3500.4}
...
const Memo = memo(SvgSublimeLight);
export default Memo;
