...
const SvgReactiveXDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      fill="url(#ReactiveX-Dark_svg__a)"
    ...
    />
    <path
      fill="url(#ReactiveX-Dark_svg__b)"
    ...
    />
    <path
      fill="url(#ReactiveX-Dark_svg__c)"
    ...
    />
    <path
      fill="url(#ReactiveX-Dark_svg__d)"
...
const Memo = memo(SvgReactiveXDark);
export default Memo;
