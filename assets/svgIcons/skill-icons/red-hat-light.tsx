...
const SvgRedHatLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="RedHat-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="RedHat-Light_svg__b">
        <path fill="#fff" d="M40 61h175v133H40z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgRedHatLight);
export default Memo;
