...
const SvgWindiCssLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#WindiCSS-Light_svg__a)"
    ...
    />
    <path
      fill="url(#WindiCSS-Light_svg__b)"
    ...
    />
    <path
      fill="url(#WindiCSS-Light_svg__c)"
    ...
    />
    <path
      fill="url(#WindiCSS-Light_svg__d)"
      d="M62.34 157.675H36v20.261h26.34z"
    />
    <defs>
      <linearGradient
        id="WindiCSS-Light_svg__a"
        x1={52}
        x2={168}
        y1={45}
        y2={228}
...
const Memo = memo(SvgWindiCssLight);
export default Memo;
