...
const SvgRiderLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <clipPath id="Rider-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="Rider-Light_svg__b">
        <path fill="#fff" d="M42.943 40.792h169.113v173.417H42.943z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgRiderLight);
export default Memo;
