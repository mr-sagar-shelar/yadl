...
const SvgAzul = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <rect width={256} height={256} fill="url(#Azul_svg__a)" rx={60} />
    <g clipPath="url(#Azul_svg__b)">
      <path
        fill="#fff"
        fillRule="evenodd"
    ...
    <defs>
      ...
      <clipPath id="Azul_svg__b">
        <path fill="#fff" d="M28 28h200v200H28z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgAzul);
export default Memo;
