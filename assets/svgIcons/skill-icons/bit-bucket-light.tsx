...
const SvgBitBucketLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#BitBucket-Light_svg__a)">
      <path
        fill="#F4F2ED"
      ...
      />
      <path
        fill="url(#BitBucket-Light_svg__b)"
    ...
    <defs>
      ...
      <clipPath id="BitBucket-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgBitBucketLight);
export default Memo;
