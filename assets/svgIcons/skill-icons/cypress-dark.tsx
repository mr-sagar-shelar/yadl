...
const SvgCypressDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#Cypress-Dark_svg__a)">
      <path
        fill="#242938"
    ...
    <defs>
      ...
      <clipPath id="Cypress-Dark_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgCypressDark);
export default Memo;
