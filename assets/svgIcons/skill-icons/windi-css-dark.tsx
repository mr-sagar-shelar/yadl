...
const SvgWindiCssDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      fill="url(#WindiCSS-Dark_svg__d)"
      d="M62.34 157.675H36v20.261h26.34z"
    />
    <defs>
      <linearGradient
        id="WindiCSS-Dark_svg__a"
        x1={52}
        x2={168}
        y1={45}
        y2={228}
...
const Memo = memo(SvgWindiCssDark);
export default Memo;
