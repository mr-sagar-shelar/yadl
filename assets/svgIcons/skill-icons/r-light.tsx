...
const SvgRLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g fillRule="evenodd" clipPath="url(#R-Light_svg__a)" clipRule="evenodd">
      <path
        fill="url(#R-Light_svg__b)"
    ...
    <defs>
      ...
      <clipPath id="R-Light_svg__a">
        <path fill="#fff" d="M28 51h200v154.972H28z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgRLight);
export default Memo;
