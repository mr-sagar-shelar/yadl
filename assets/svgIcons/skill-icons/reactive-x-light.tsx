...
const SvgReactiveXLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      fill="url(#ReactiveX-Light_svg__a)"
    ...
    />
    <path
      fill="url(#ReactiveX-Light_svg__b)"
    ...
    />
    <path
      fill="url(#ReactiveX-Light_svg__c)"
    ...
    />
    <path
      fill="url(#ReactiveX-Light_svg__d)"
...
const Memo = memo(SvgReactiveXLight);
export default Memo;
