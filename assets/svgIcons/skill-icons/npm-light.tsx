...
const SvgNpmLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="Npm-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="Npm-Light_svg__b">
        <path fill="#fff" d="M23 88h210v80H23z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgNpmLight);
export default Memo;
