...
const SvgPowershellLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#Powershell-Light_svg__a)"
      fillRule="evenodd"
    ...
    />
    <path
      fill="url(#Powershell-Light_svg__b)"
      fillRule="evenodd"
...
const Memo = memo(SvgPowershellLight);
export default Memo;
