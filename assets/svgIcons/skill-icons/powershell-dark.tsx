...
const SvgPowershellDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#Powershell-Dark_svg__a)"
      fillRule="evenodd"
    ...
    />
    <path
      fill="url(#Powershell-Dark_svg__b)"
      fillRule="evenodd"
...
const Memo = memo(SvgPowershellDark);
export default Memo;
