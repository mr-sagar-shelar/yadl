...
const SvgVuetifyDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="Vuetify-Dark_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="Vuetify-Dark_svg__b">
        <path fill="#fff" d="M40 69h175v152H40z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgVuetifyDark);
export default Memo;
