...
const SvgWebStormLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <clipPath id="WebStorm-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="WebStorm-Light_svg__b">
        <path fill="#fff" d="M40 40h175v175H40z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgWebStormLight);
export default Memo;
