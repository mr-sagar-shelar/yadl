...
const SvgVuetifyLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="Vuetify-Light_svg__a">
        <path fill="#fff" d="M0 0h256v256H0z" />
      </clipPath>
      <clipPath id="Vuetify-Light_svg__b">
        <path fill="#fff" d="M40 69h175v152H40z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(SvgVuetifyLight);
export default Memo;
